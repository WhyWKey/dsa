...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text =  "Aimbot By : Xaxa Silent By : Stefunk If Script Is Laggy Enabled esp all options ands turn them off again";
  })
    ...
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/WhyWKey/dsa/main/Library.lua"))()
    WindowYSize=545
    ...
    local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/WhyWKey/dsa/main/esp.lua", true))()
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-122.52713012695, 22.125370025635, -873.95684814453)
        ...
        getgenv().urspeed = bool
         getgenv().urspeed = value
           ...
           ragecheatchar:Toggle("Enable", function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/WhyWKey/dsa/main/ragech.lua"))()
            end)
    ...
    ragecheatchar:Textbox("Walkspeed", function(a)
        ...
        ["clear"] = false,
           ...
           ragecheatchar:Toggle("Fly", function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/WhyWKey/dsa/f6a870eadba387b510ddb96dc48787021cee4933/Rage.lua"))()
           end)
    ...
    ragecheatchar:Button("Recoil", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/WhyWKey/dsa/main/Ragech2.lua"))()
    end)


    local Aiming = loadstring(game:HttpGet("https://raw.githubusercontent.com/WhyWKey/dsa/main/Aiming.lua"))()
